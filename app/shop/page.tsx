        ...
        <PageHero mediaKey="shop.hero">
          <header className="flex flex-col gap-7 border-b border-[#242721]/20 pb-9 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <p className="text-[0.6875rem] font-bold uppercase tracking-[0.22em] text-[#7b2430]">The tack trunk</p>
              <h1 className="mt-4 font-serif text-5xl tracking-[-0.045em] text-[#242721] sm:text-6xl">Useful things for the horse-world life.</h1>
              <p className="mt-5 text-lg leading-8 text-[#56584f]">A curated board of resources and goods that send you directly to the seller when you are ready.</p>
            </div>
            <div className="flex flex-wrap gap-3">
              <Link href="/shop/new" className="inline-flex border border-[#2d4737] bg-[#2d4737] px-4 py-2.5 text-sm font-bold text-[#f9f4eb] transition-colors hover:bg-[#7b2430]">Add a shop item <span className="ml-2" aria-hidden="true">↗</span></Link>
              <Link href="/shop/mine" className="inline-flex border border-[#2d4737] px-4 py-2.5 text-sm font-bold text-[#2d4737] transition-colors hover:border-[#7b2430] hover:text-[#7b2430]">Manage my items</Link>
            </div>
          </header>
        </PageHero>
