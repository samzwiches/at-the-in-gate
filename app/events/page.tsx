    ...
    <main className="bg-[#f4efe5] py-12 sm:py-16">
      <PageContainer>
        ...
        <header className="max-w-3xl">
          <p className="text-[0.6875rem] font-bold uppercase tracking-[0.22em] text-[#7b2430]">The show circuit</p>
          <h1 className="mt-4 font-serif text-5xl tracking-[-0.045em] text-[#242721] sm:text-6xl">Know where everyone is headed.</h1>
          <p className="mt-5 text-lg leading-8 text-[#56584f]">Shows, finals, and clinics submitted by the people organizing the week.</p>
          <Link href="/events/new" className="mt-7 inline-flex border border-[#2d4737] bg-[#2d4737] px-4 py-2.5 text-sm font-bold text-[#f9f4eb] transition-colors hover:bg-[#7b2430]">Add an event <span className="ml-2" aria-hidden="true">↗</span></Link>
        </header>
        </PageHero>
