    ...
    <main className="bg-[#f4efe5] py-12 sm:py-16">
      <PageContainer>
        <div className="mx-auto max-w-4xl">
          ...
          <JobForm job={job} directoryEntries={directoryEntries} events={events} />
          <Link href={`/jobs/${job.slug}`} className="mt-7 inline-flex border-b border-[#2d4737] pb-1 text-sm font-bold text-[#2d4737] transition-colors hover:border-[#7b2430] hover:text-[#7b2430]">Back to posting</Link>
        </div>
      </PageContainer>
    </main>
  );
