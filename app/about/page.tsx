...
export default function AboutPage() {
  return (
    <PageCanvas appearanceKey="about.page" tone="cream" className="py-12 sm:py-16"><PageContainer>
      <PageHero mediaKey="about.hero"><div className="grid gap-10 border-b border-[#242721]/20 pb-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end"><div><p className="text-[0.6875rem] font-bold uppercase tracking-[0.22em] text-[color:var(--section-eyebrow-color,#7b2430)]">About At The In Gate</p><h1 className="section-appearance-heading-font mt-4 max-w-4xl text-5xl tracking-[-0.045em] text-[color:var(--section-heading-color,#242721)] sm:text-6xl lg:text-7xl">The horse world already has a front row. We&apos;re making it easier to find.</h1></div><p className="section-appearance-body-font text-lg leading-8 text-[color:var(--section-body-color,#56584f)]">At The In Gate is a community-first home for hunter, jumper, equitation, and pony people—a better place to find opportunities, share knowledge, and feel more connected to the world around the ring.</p></div></PageHero>
