...
export default async function SiteMediaAdminPage() {
  ...
  const media = await getSiteMediaForAdmin();
    ...
    <main className="bg-[#e7e1d5] py-12 sm:py-16">
      <PageContainer>
        ...
        <header className="mt-8 border-b border-[#242721]/20 pb-8">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-[#56584f]">These fixed slots preserve the site&apos;s layout while letting you replace approved page imagery, crop it deliberately, and protect the words sitting over it. There is no freeform styling here—just the media decisions that matter.</p>
