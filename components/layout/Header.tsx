...
export default async function Header() {
  ...
  return (
    <header className="border-b border-[#242721]/20 bg-[#f4efe5]">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between px-5 py-4 sm:px-8 lg:px-12">
        <Link href="/" className="group flex items-center gap-3" aria-label="At The In Gate home">
          <span className="flex size-9 items-center justify-center border border-[#b08d57] text-sm font-bold text-[#2d4737]">A</span>
          <span className="leading-none">
            <span className="block font-serif text-lg tracking-[-0.03em] text-[#242721]">At The In Gate</span>
            <span className="mt-1 block text-[0.55rem] font-bold uppercase tracking-[0.22em] text-[#5a645d]">The show book</span>
          </span>
        </Link>
        <MainNavigation />
        <div className="hidden items-center gap-4 lg:flex">
          <Link href="/marketplace" className="text-sm font-medium text-[#383a33] transition-colors hover:text-[#7b2430]">Search</Link>
