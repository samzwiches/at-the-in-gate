...
export const SITE_SECTION_APPEARANCE_SECTIONS = [
  ...
  },
  {
    ...
    group: "Footer",
    kind: "footer",
    guidance: "The sitewide close, including its navigation and invitation. Button text controls the invitation text; Surface color controls its button background.",
  ...
  },
  {
    ...
    group: "Home",
    kind: "hero",
    guidance: "The opening message and the field-notes panel beside it. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
  ...
  },
  {
    ...
    group: "Marketplace",
    kind: "hero",
    guidance: "The market-board introduction above the browse controls. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/marketplace"],
  },
  {
    ...
    group: "Community",
    kind: "hero",
    guidance: "The member-space introduction at the top of Community. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/community"],
  },
  {
    ...
    group: "Events",
    kind: "hero",
    guidance: "The show-circuit introduction above event filters. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/events"],
  },
  {
    ...
    group: "Directory",
    kind: "hero",
    guidance: "The people-and-programs introduction above category controls. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/directory"],
  },
  {
    ...
    group: "Jobs",
    kind: "hero",
    guidance: "The barn-calls introduction above role categories. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/jobs"],
  },
  {
    ...
    group: "Membership",
    kind: "hero",
    guidance: "The member-pass introduction at the top of Membership. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/membership"],
  },
  {
    ...
    group: "Shop",
    kind: "hero",
    guidance: "The tack-trunk introduction above the collection categories. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/shop"],
  },
  {
    ...
    group: "About",
    kind: "hero",
    guidance: "The opening editorial statement on the About page. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/about"],
  },
  {
    ...
    group: "Contact",
    kind: "hero",
    guidance: "The opening note above the contact form. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/contact"],
  },
  {
    ...
    group: "Services",
    kind: "hero",
    guidance: "The services introduction above category navigation. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/services"],
  },
  {
    ...
    group: "Shippers",
    kind: "hero",
    guidance: "The shipping-routes introduction above the route board. Button text controls button lettering; Surface color controls the primary button background; Section background color controls its hover background; Border color controls the secondary button accent.",
    controls: ["font", "default", "eyebrow", "heading", "body", "button", "metadata", "background", "surface", "border", "heroEdgeStyle", "heroEdgeSize"],
    paths: ["/shippers"],
  },
  {
...
export const SITE_SECTION_APPEARANCE_BRAND_SWATCHES = [
  { label: "Deep espresso", value: "#2c221e" },
  { label: "Tack room parchment", value: "#f7f4ee" },
  { label: "Saddle warm neutral", value: "#efece4" },
...
export const SITE_SECTION_APPEARANCE_FIELD_LABELS: Record<SiteSectionAppearanceControl, string> = {
  ...
  background: "Section background color / primary button hover",
  surface: "Surface color / primary button background",
  border: "Border color / secondary button accent",
...
export const SITE_SECTION_BUTTON_BACKGROUNDS = ["#3e4a3f", "#4a5342"] as const;
